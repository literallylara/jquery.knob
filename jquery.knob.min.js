 ...
 */
;(function(c){"function"==typeof define&&define.amd?define(["jquery"],c):"undefined"!==typeof module&&module.exports?module.exports=c:c(window.jQuery||window.$)})(function(c){c.widget("custom.knob",{options:{bgColor:"#000",fgColor:"#fff",type:"vol",tooltip:!0,turnWith:null,arc:360,steps:100,offset:0,range:"auto",invertRange:!1,fineTuneFactor:10,value:0,resetValue:0,classPrefix:"knob"},_$svg:null,_$stroke:null,__$tooltip:null,_value:null,_grabValue:null,_grabOffset:null,_rangeFine:null,_shiftKey:null,
_pageY:null,_create:function(){var a=this,b=this.options;Object.keys(b).forEach(function(c){var e=a.element.data(c.toLowerCase());b[c]=void 0!==e?e:b[c]});this._$svg=c('\n\t\t\t<svg viewBox="0 0 2 2">\n\t\t\t\t<circle class="'+b.classPrefix+'-stroke" cx="1" cy="1" r="1" clip-path="url(#knob-clip'+this.uuid+')" />\n\t\t\t\t<clipPath id="knob-clip'+this.uuid+'"><circle cx="1" cy="1" r="1" /></clipPath>\n\t\t\t</svg>').appendTo(this.element);this._$stroke=this._$svg.find("circle:eq(0)").css({fill:b.bgColor,
